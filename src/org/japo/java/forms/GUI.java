...
public class GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnlAjustesLayout.setHorizontalGroup(
            ...
            .addGroup(pnlAjustesLayout.createSequentialGroup()
                ...
                .addComponent(sldTalla, javax.swing.GroupLayout.PREFERRED_SIZE, 551, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void btnCargarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCargarActionPerformed
        procesarImportacionXML();
    }//GEN-LAST:event_btnCargarActionPerformed

    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        procesarExportacionXML();
...
//        }
    ...
    private void sincronizarModeloInterfaz() {
        ...
        // Talla
        UtilesSwing.ajustarValorDeslizador(sldTalla, modelo.getTalla());
        UtilesSwing.ajustarValorCambiador(spnTalla, modelo.getTalla());
...
//        return item1OK && item2OK && item4OK && item5OK;
    ...
    private void procesarTalla(ChangeEvent evt) {
        // Interfaz > modelo
        if (evt.getSource().equals(sldTalla)) {
            modelo.setTalla(sldTalla.getValue());
        } else {
            modelo.setTalla((int) spnTalla.getValue());
        }
